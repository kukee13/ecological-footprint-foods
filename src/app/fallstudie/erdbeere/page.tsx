...
const CS_TRANS = {
  de: {
    ...
    market: {
      ...
      summaryBody: 'Deutschland produziert nur noch rund 50 % seines Erdbeerbedarfs selbst — 2015 waren es noch 68 %. Gleichzeitig steigt der Anteil des geschützten Anbaus (Folie/Glas), der zwar ertragreicher, aber auch energieintensiver ist. Die Lücke füllen Importe — vor allem aus Spanien.',
      summaryBold: '50 % seines Erdbeerbedarfs',
  ...
  en: {
    ...
    market: {
      ...
      summaryBody: 'Germany now produces only around 50% of its strawberry needs domestically — down from 68% in 2015. At the same time, the share of protected (polytunnel/glass) growing is rising; it is more productive but also more energy-intensive. The gap is filled by imports — above all from Spain.',
      summaryBold: '50% of its strawberry needs',
